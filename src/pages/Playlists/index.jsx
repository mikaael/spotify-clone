  ...
  return (
    <div className='flex text-slate-100'>
      <div className='bg-black w-[18%] min-h-screen p-6'>
        <Link
          to='/'
          className='text-2xl font-semibold w-32 flex items-center mb-8'
        >
        ...
        <div className='flex flex-col gap-4 mb-10'>
          <div className='text-slate-100 flex gap-4 items-center'>
            ...
            <div className='font-extrabold text-xs'>Início</div>
          </div>
          ...
          <div className='text-[#c4c4c4] flex gap-4 items-center'>
            ...
            <div className='text-xs'>Biblioteca</div>
          </div>
        </div>
        ...
        <div className='flex flex-col gap-4'>
          <div className='text-[#c4c4c4] flex gap-4 items-center'>
            ...
            <div className='text-xs'>Criar playlist</div>
          </div>
          <div className='text-[#c4c4c4] flex gap-4 items-center'>
            ...
            <div className='text-xs'>Músicas Curtidas</div>
          </div>
        </div>
      </div>
