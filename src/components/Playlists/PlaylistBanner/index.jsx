  ...
  return (
    <>
      ...
      >
        ...
        <div class="group relative cursor-pointer items-center justify-center overflow-hidden w-80 hover:opacity-50">
          <div>
            <img
              src={playlistBanner}
          ...
          <div class="absolute inset-0 flex flex-col items-center justify-center text-center transition-all duration-500 group-hover:translate-y-0">
            <PencilIcon class="w-12 text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
            <p class="mb-3 text-lg text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100 font-bold">
              Escolher foto
            </p>
          </div>
        </div>
